---
title: Visualizar manuscritos 2 (atualização)
subtitle: Uma ferramenta de visualização de manuscritos com múltiplos critérios

# Summary for listings and search engines
summary: Nova versão do treemap interativo, com funcionalidades adicionais. 
...
- Notas
---
Como prometido, eis uma nova versão do treemap interativo apresentado num [artigo anterior]({{< relref "/post/treemap" >}}), desta vez com dois modos de visualização.
