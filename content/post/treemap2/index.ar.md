...
subtitle: أداة لتصوّر المخطوطات بمعايير متعددة

# Summary for listings and search engines
summary: نسخة أحدث من الخريطة الشجرية التفاعلية، زُوِّدت بميزات إضافية. 
...
- ملاحظات
---
وفاءً بما وعدت، هذه نسخة جديدة من الخريطة الشجرية التفاعلية التي عرضتها في [تدوينة سابقة]({{< relref "/post/treemap" >}})، وقد صارت هذه المرة بوضعَي عرض.
