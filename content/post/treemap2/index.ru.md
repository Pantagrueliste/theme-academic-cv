---
title: Визуализация рукописей 2 (обновление)
subtitle: Инструмент визуализации рукописи по нескольким критериям

# Summary for listings and search engines
summary: Новая версия интерактивной древовидной карты с дополнительными возможностями. 
...
- Заметки
---
Как и обещал, новая версия интерактивной древовидной карты из [прошлой заметки]({{< relref "/post/treemap" >}}) — на сей раз с двумя режимами просмотра.
