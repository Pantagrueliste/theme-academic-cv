...
Com acesso antecipado à API da OpenAI desde maio de 2021, pude experimentar a capacidade do modelo para resolver várias tarefas de reputada dificuldade: traduzir poesia francesa e textos neolatinos para inglês, explicar analogias e até simplificar a terceira secção da *Fundamentação da Metafísica dos Costumes* de Kant para uma criança de sete anos (sem grande convicção, diga-se).
