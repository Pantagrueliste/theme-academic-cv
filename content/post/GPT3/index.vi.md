...
Được tiếp cận sớm API của OpenAI từ tháng 5 năm 2021, tôi đã có dịp thử nghiệm khả năng của mô hình trong một số nhiệm vụ vốn được xem là khó: dịch thơ Pháp và văn bản tân Latinh sang tiếng Anh, giải thích phép loại suy, thậm chí giản lược Phần 3 của *Groundwork for a Metaphysics of Morals* (Kant) cho một đứa trẻ bảy tuổi (dù chưa thật thuyết phục).
